...
<template>
    <nav :class="scrollValue >= 250 ? 'hidden' : ''" class="absolute top-0 right-0 z-10 w-full border-gray-200 py-4 bg-fixed bg-center bg-no-repeat bg-[url('/images/hero.png')] bg-cover bg-gray-600 bg-blend-multiply h-[300px]">
    ...
    <nav v-if="scrollValue >= 250" class="fixed top-0 right-0 z-10 w-full bg-white shadow border-gray-200 py-4">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo" />
            ...
            <div :class="isMenuOpen ? 'block' : 'hidden'" class="w-full md:block md:w-auto" id="navbar-default">
                <ul class="text-xl font-bold flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                    <li>
                        <Link :href="route('announcement.index')" :class="scrollValue >= 250 ? 'text-gray-700' : 'text-gray-100'" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Announcements</Link>
                    </li>
                    <li>
                        <Link :href="route('achievement.index')" :class="scrollValue >= 250 ? 'text-gray-700' : 'text-gray-100'" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Achievements</Link>
                    </li>
                    <li>
                        <Link href="/research" :class="scrollValue >= 250 ? 'text-gray-700' : 'text-gray-100'" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Research</Link>
                    </li>
                    <li>
                        <Link href="/login" :class="scrollValue >= 250 ? 'text-gray-700' : 'text-gray-100'" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Login</Link>
                    </li>
                </ul>
            </div>
        </div>
