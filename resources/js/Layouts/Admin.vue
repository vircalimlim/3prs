  ...
  >
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
      <div class="mb-2 text-end block md:hidden">
        <span @click="handleMenu" class="text-[30px] text-gray-700 px-2 cursor-pointer rounded hover:bg-gray-200">&times;</span>
      </div>
      <img class="h-15 p-2 mb-5" src="/images/logo-without-bg.png" alt="">
